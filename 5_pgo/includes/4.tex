...
\section{Drátěné (hranové) modely (wireframe model)}
\begin{itemize}
...
\section{Hraniční metoda (hraniční model)}
\begin{itemize}
...
\section{Výčet prostoru - BSP stromy}
...
\subsection{Struktura oktantových stromů}
\begin{itemize}
