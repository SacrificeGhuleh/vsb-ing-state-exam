...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/ipv4-header}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{assets/6_ip4}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{assets/4_ipv6}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{assets/6_nat_out}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{assets/6_nat_in}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{assets/6_pat_mask}
\end{figure}