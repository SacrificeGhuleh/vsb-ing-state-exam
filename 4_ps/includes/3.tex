...
\section{Generické komponenty OS} % https://publi.cz/books/11/04.html
...
\subsection{Správa procesorů/procesů}
...
\subsection{Uživatelské rozhraní - interpret příkazů}
...
\subsection{Vnitřní služby operačního systému}
