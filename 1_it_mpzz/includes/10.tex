...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{assets/10_clustering}
\end{figure}

\subsection{Dendrogram}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{assets/10_dendrogram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{assets/10_kmeans}
\end{figure}
