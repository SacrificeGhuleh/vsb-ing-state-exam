...
\\\\
\noindent\makebox[\textwidth]{\includegraphics[width=.6\textwidth]{assets/sekv}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{assets/diag_aktivit.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{assets/diag_aktivit_swimlines}
\end{figure}